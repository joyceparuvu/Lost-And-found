...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.min.js" integrity="sha384-mQ93GR66B00ZXjt0YO5KlohRA5SY2XofN4zfuZxLkoj1gXtW8ANNCe9d5Y3eG5eD" crossorigin="anonymous"></script>
    ...
    <?php   if($result->num_rows>0){
                    while($row=$result->fetch_assoc()){ ?>
                            ...
                            <div class="image m-5">
                                <img alt="img" class="w-50 img-fluid" src="images/message/<?php echo $row['image']?>">
                            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text"><span style="color: #ff6700; font-size:15px;">Time:</span><span style="font-size:15px;"><?php echo $row['time'];?>  </p>
                <p class="card-text"><span style="color: #ff6700; font-size:15px;">Description:</span><span style="font-size:15px;"><?php echo $row['message'];?> </p>
                <p class="card-text"><span style="color: #ff6700; font-size:15px;">Founded By :</span><span style="font-size:15px;"><?php echo $row['name'];?>	</p>
                <p class="card-text"><span style="color: #ff6700; font-size:15px;">Person Email :</span><span style="font-size:15px;"><?php echo $row['email'];?>  </p>
                ...
                <a class="btn btn-dark btn-block" href="connection_files/manage.php?id=<?php echo $row["id"];?>&found=found">Claim</a>
...
<div class="col-6 my-auto"> <h3 class="my-auto">Contact the person to send their Items</h3>
...
<h3 class="my-3">Send mail to the person posted<h3>
<div class="input-group mb-4">
 
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-dark"  id="inputGroup-sizing-default">Your mail address*</span>
                            </div>
                            <input type="mail" name="mobile" maxlength="14" required class="form-control" required placeholder="Enter your mailid here" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                        </div>
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-dark" id="inputGroup-sizing-default">Message*</span>
                            </div>
                            <input type="text" name="item" required class="form-control"  requiredplaceholder=" Enter your message here" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                        </div>
</div>
