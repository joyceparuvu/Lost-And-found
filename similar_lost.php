...
<?php
  ...
  if(isset($_GET['item'])) {
    ...
    $item=$_GET['item'];}
  $sql="SELECT * FROM `lost` where `item`='$item'";
...
<body>
    ...
    <div class="carousel slide" data-bs-ride="carousel" id="carouselExample3">
                        ...
                        <div class="carousel-inner">
                            <div class="image m-5 p-5">
                                <img alt="img" class="d-block w-100" src="images/message/<?php echo $row['image']?>" width="540" height="300">
                            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-primary btn-block" href="lost_details.php?id=<?php echo $row["id"];?>">Check Now</a>
