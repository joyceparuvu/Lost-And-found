...
<body>
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark">
        <a class="navbar-brand grow mx-auto" href="../index.php">Lost and Found</a>
        ...
        <section>
            <div class="container" id="main-container">
                ...
                <div class="container p-5 mt-5" id="form-container">
                    ...
                    <h1 class="text-center">Login Here <i class="far fa-smile-beam"></i></h1>
                    <form class="mt-4" action="../connection_files/login_check.php" method="POST">
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-dark" id="inputGroup-sizing-default">Email*</span>
                            </div>
                            <input type="email" name="email" required class="form-control" placeholder="cenajohn@gmail.com"
                                aria-label="Default" aria-describedby="inputGroup-sizing-default">
                        </div>
                        
                        <!-- <div class="input-group mb-4">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-dark" id="inputGroup-sizing-default">Year*</span>
                            </div>
                        ...
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-dark" id="inputGroup-sizing-default">Branch*</span>
                            </div>
                            <select id="inputState" class="form-control">
                                <option selected>Choose...</option>
                                <option value="cse">Computer Science Engineering</option>
                                <option value="it">Information Technology</option>
                                <option value="ec">Electronics And Commuication Engineering</option>
                        ...
                        <div class="input-group mb-4">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-dark" id="inputGroup-sizing-default">Password*</span>
                            </div>
